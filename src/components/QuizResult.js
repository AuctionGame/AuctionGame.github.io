    ...
    if (this.state.toShowSelected) {
      ...
      return (
        <Fragment>
          ...
          <div id="navbar" className="container-fluid">
            <div className="row">
              <div className="col center" onClick={this.showQuiz}> Quiz Results </div>
              <div className="col center text-info" onClick={this.showIPO}> IPO Leaderboard </div>
            </div>
      ...
      return (
        <Fragment>
          <div id="navbar" className="container-fluid">
            <div className="row">
              <div className="col center text-info" onClick={this.showQuiz}> Quiz Results </div>
